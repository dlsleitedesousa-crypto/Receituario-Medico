...
(() => {
  ...
  form.innerHTML = `<form class="apac-editor-panel" id="apacForm">
    ...
    </div><p class="apac-catalog-status" id="apacCatalogStatus" role="status">Carregando tabela SIGTAP e CID-10…</p><div class="actions"><button class="btn blue" type="submit">Visualizar e imprimir APAC</button></div>
  </form>`;
