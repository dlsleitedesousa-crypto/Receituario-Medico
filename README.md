...
O botão **AIH** abre um formulário apenas com procedimento principal e código SIGTAP, CID-10 principal, sinais e sintomas, condições que justificam a internação e principais resultados diagnósticos. Procedimento e CID têm busca por nome ou código nos catálogos SIGTAP do SUS da competência 09/2026; a escolha do procedimento preenche seu código, e os dois códigos são validados antes de salvar ou gerar o PDF. O PDF usa o formulário original em `assets/aih-modelo.pdf` e preenche também os dados já disponíveis do paciente, local e profissional. Os outros campos do formulário original ficam em branco. **Salvar modelo** fica ao lado de **Gerar PDF da AIH**; os modelos são pesquisáveis e ordenados por nome, e guardam apenas os seis campos do formulário AIH, sem dados pessoais do paciente. O catálogo de procedimentos é gerado com `node tools/build-aih-catalog.mjs sigtap-202609.zip` e o de CID-10 é compartilhado com a APAC.
